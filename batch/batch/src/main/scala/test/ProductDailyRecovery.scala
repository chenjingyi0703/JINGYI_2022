...
object ProductDailyRecovery {
  ...
  def main(args: Array[String]): Unit = {
    ...
    */
    val yesterdayDate = "20191024"
    val yesterdayBeforeDate = "20191023"
    val inputDate = "20191029"
    ...
    chacOrderList.foreachPartition(part => {
      ...
      part.foreach(line => {
        ...
        //浏览量全部
        if (rankc <= 10000) {
          val put = new Put((title + inputDate + "不限c" + rankc).getBytes)
        ...
        //销量全部
        if (ranks <= 10000) {
          val put2 = new Put((title + inputDate + "不限s" + ranks).getBytes)
        ...
        //浏览量行业
        if (ranklc <= 10000) {
          val put3 = new Put((title + inputDate + label + "c" + ranklc).getBytes)
        ...
        //销量行业
        if (rankls <= 10000) {
          val put4 = new Put((title + inputDate + label + "s" + rankls).getBytes)
        ...
        //浏览量来源
        if (rankpfc <= 10000) {
          val put5 = new Put((title + inputDate + pflabel + "c" + rankpfc).getBytes)
        ...
        //销量来源
        if (rankpfs <= 10000) {
          val put6 = new Put((title + inputDate + pflabel + "s" + rankpfs).getBytes)
        ...
        //浏览量行业来源
        if (ranklcpf <= 10000) {
          val put7 = new Put((title + inputDate + label + pflabel + "c" + ranklcpf).getBytes)
        ...
        //销量行业来源
        if (ranklspf <= 10000) {
          val put8 = new Put((title + inputDate + label + pflabel + "s" + ranklspf).getBytes)
    ...
    maleProductOrder.foreachPartition(part => {
      ...
      part.foreach(line => {
        ...
        if (rankpfc <= 10000) {
          val put3 = new Put((title + inputDate + pflabel + "c" + rankpfc).getBytes)
          put3.addColumn(Bytes.toBytes("r"), Bytes.toBytes("prov"), Bytes.toBytes(prov))
          put3.addColumn(Bytes.toBytes("r"), Bytes.toBytes("city"), Bytes.toBytes(city))
          put3.addColumn(Bytes.toBytes("r"), Bytes.toBytes("age"), Bytes.toBytes(age))
        ...
        if (rankpfs <= 10000) {
          val put4 = new Put((title + inputDate + pflabel + "s" + rankpfs).getBytes)
          put4.addColumn(Bytes.toBytes("r"), Bytes.toBytes("prov"), Bytes.toBytes(prov))
          put4.addColumn(Bytes.toBytes("r"), Bytes.toBytes("city"), Bytes.toBytes(city))
          put4.addColumn(Bytes.toBytes("r"), Bytes.toBytes("age"), Bytes.toBytes(age))
